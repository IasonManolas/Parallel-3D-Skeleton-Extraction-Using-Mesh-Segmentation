...
public:
    ...
    void segmentMesh(){
        ...
        // create a property-map ean are you sure the edge sean are you sure the edge shared by two triangles is not duplicatehared by two triangles is not duplicatefor segment-ids
    ...
    bool intersects(Kernel::Ray_3 ray,
        ...
        if (intersection) {
            ...
            if (boost::get<Point>(&(intersection->first))) {
                ...
                glm::vec3 intersectionPos =glm::vec3(modelMatrix * glm::vec4(vertices[intersectionIndex].Position, 1.0));
...
//               CGAL::Polygon_mesh_processing::orient_polygon_soup(points,polygons);
        ...
        CGAL::Polygon_mesh_processing::polygon_soup_to_polygon_mesh(points,
                                                                    polygons, M);
        if(!CGAL::is_closed(M)) CGAL::Polygon_mesh_processing::stitch_borders(M);
